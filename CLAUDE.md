...
- **Fases pendentes**: D (página do cliente mostra a mídia do relato logo abaixo da queixa; PDF ganha os mesmos blocos de achado/antes-depois dentro do capítulo certo), E (dashboard com filtro Abertas/Concluídas/Todas usando o `?status=` da Fase A).
