/**
 * Catálogo de descrições de DTC usado na CAPTURA: o snapshot vem do firmware
 * só com os códigos, e aqui cada um ganha a descrição antes de virar Test —
 * assim página do cliente, PDF e histórico exibem o mesmo texto sem cada um
 * ter seu próprio catálogo. Espelho do frontend `src/lib/dtcCodes.ts`.
 */
